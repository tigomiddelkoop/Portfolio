...
export default function Home(): React.JSX.Element {
    ...
    return (
        <>
            <div
                className={'flex h-screen flex-col items-center justify-center px-4 py-6 dark:border-gray-600 xl:px-12 xl:py-10'}
            >
                <div className="mb-3 flex flex-col items-center justify-center md:flex-row ">
                    <Image
                        className={'h-24 w-24 rounded-full border-2 border-purple-900 shadow-lg dark:border-slate-900 xl:mr-4 xl:h-32 xl:w-32'}
                        alt="Tigo"
                        src={'/img/pf_new.jpg'}
                    ...
                    <div
                        className={'bg-gradient-to-br from-white to-purple-600 bg-clip-text text-center text-transparent dark:to-slate-600'}
                    >
                        <h1 className="mb-1 text-4xl md:text-6xl font-normal">
                ...
                <div
                    className={'mb-2 h-auto text-wrap p-0 text-center font-black text-purple-300 dark:text-slate-300'}
                >
                    <p>
                        PHP, TypeScript
            ...
            <div
                className={'absolute bottom-5 -z-10 flex w-full animate-bounce flex-col text-center text-purple-300 dark:text-slate-300'}
            >
            ...
            <Separator className={'mb-8'} /><Container>
            <div>
...
*/}
        </Container><Separator className={'my-8 w-1/2'} /><Container id={'experience'}>
            ...
            <Grid>
                {projects.map((project: any) => {
                    console.log(project)
                    return <SkillCard key={project.name} data={project} last={false} />
                })}
            </Grid>
        </Container><Separator className={'my-8'} /><Container id={'projects'}>
            <div className={'text-center'}>
